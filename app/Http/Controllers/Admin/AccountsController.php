...
class AccountsController extends Controller
{
    ...
    public function index() {
        ...
        return view('admin.accounts', compact('mentors', 'traders', 'webmasters'));
    }
    ...
    public function action($action, $user_id, Request $request) {
        ...
        if ($action === 'ev') {  //Edit view
            ...
            $data = User::find($user_id);
            return view('admin.editaccount', compact('data'));
            ...
            if ($rlt === 1) {
                return redirect('/g1/accounts/ev/'.$user_id);
            }
