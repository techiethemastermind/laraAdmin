                ...
                <div class="panel-heading">
                    <div  class="tab-struct custom-tab-1">
                        <ul role="tablist" class="nav nav-tabs ver-nav-tab" id="accounts_tablist">
                            <li class="active"><a  data-toggle="tab" id="trader_tab" role="tab" href="#traders" aria-expanded="false">Traders</a></li>
                ...
                <div class="panel-wrapper collapse in">
                    <div class="panel-body">
                        <div id="accounts_tabs" class="table-wrap tab-content">
                            <div id="traders" class="table-responsive tab-pane fade active in" role="tabpanel">
