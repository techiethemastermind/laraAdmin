                ...
                <div class="panel-heading">
                    <div  class="tab-struct custom-tab-1">
                        <ul role="tablist" class="nav nav-tabs ver-nav-tab" id="accounts_tablist">
                            <li class="active"><a aria-expanded="true"  data-toggle="tab" role="tab" id="admin_tab" href="#admins">Admins</a></li>
                            <li class=""><a  data-toggle="tab" id="mentor_tab" role="tab" href="#mentors" aria-expanded="false">Mentors</a></li>
                                                ...
                                                <div class="panel-wrapper collapse in">
                                                    <div class="panel-body pa-0">
                                                        <div class="col-sm-12 col-xs-12">
                                                            <div class="form-wrap">
                                                                <form role="form" method="POST" action="{{ url('/s0/accounts/cn/0') }}" data-toggle="validator">
                                                                {{ csrf_field() }}
                ...
                <div class="panel-wrapper collapse in">
                    <div class="panel-body">
                        <div id="accounts_tabs" class="table-wrap tab-content">
                            <div id="admins" class="table-responsive tab-pane fade active in" role="tabpanel">
                                <table id="dt_admins" class="table table-hover display  pb-30" >
                                    <thead>
                                        <tr>
                                            <th>Picture</th>
                                            <th>Name</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="account_action" href="#"><i class="fa fa-sign-in"></i> Login</a>
                            ...
                            <div id="mentors" class="table-responsive tab-pane fade" role="tabpanel">
